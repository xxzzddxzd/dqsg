...
// SVAPI.get_StartupKey — RVA 0x549CC24 (1.0.2)
...
// DMCryptography.EncryptRequest — RVA 0x5462E48 (1.0.2)
...
// DMCryptography.DecryptResponse — RVA 0x5463770 (1.0.2)
...
// DMCryptography.RandomBytes — RVA 0x546271C (1.0.2)
...
// DMCryptography.PublicEncrypt — RVA 0x54627C4 (1.0.2)
...
// DMCryptography.HmacSha1 — RVA 0x5462858 (1.0.2)
...
// DMHttpApi.<>c__DisplayClass17_0.<Login>b__0 — RVA 0x5467E44 (1.0.2)
...
// Lib.XorBytes — RVA 0x54681E0 (1.0.2)
...
// DMCryptography.SessionDecrypt — RVA 0x5462960 (1.0.2)
...
static void onImageLoaded(const struct mach_header *mh, intptr_t slide) {
    ...
    MSHookFunction((void *)(g_unityBase + 0x549CC24), (void *)hook_GetStartupKey, (void **)&orig_GetStartupKey);
    MSHookFunction((void *)(g_unityBase + 0x5462E48), (void *)hook_EncryptRequest, (void **)&orig_EncryptRequest);
    MSHookFunction((void *)(g_unityBase + 0x5463770), (void *)hook_DecryptResponse, (void **)&orig_DecryptResponse);
    MSHookFunction((void *)(g_unityBase + 0x546271C), (void *)hook_RandomBytes, (void **)&orig_RandomBytes);
    MSHookFunction((void *)(g_unityBase + 0x54627C4), (void *)hook_PublicEncrypt, (void **)&orig_PublicEncrypt);
    MSHookFunction((void *)(g_unityBase + 0x5462858), (void *)hook_HmacSha1, (void **)&orig_HmacSha1);
    MSHookFunction((void *)(g_unityBase + 0x5467E44), (void *)hook_LoginCallback, (void **)&orig_LoginCallback);
    MSHookFunction((void *)(g_unityBase + 0x54681E0), (void *)hook_XorBytes, (void **)&orig_XorBytes);
    MSHookFunction((void *)(g_unityBase + 0x5462960), (void *)hook_SessionDecrypt, (void **)&orig_SessionDecrypt);
